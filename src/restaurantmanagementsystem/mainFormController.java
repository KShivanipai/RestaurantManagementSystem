...
public class mainFormController implements Initializable {
            ...
            try {
                ...
                if (result.next()) {
                    ...
                    String insertData = "INSERT INTO product"
                            + "(prod_id,prod_name,category,stock,price,status,image,date)"
                            + "VALUES(?,?,?,?,?,?,?,?)";
    ...
    public void inventoryUpdateBtn() {
        ...
        if (inventory_productID.getText().isEmpty()
            ...
            String updateData = "UPDATE product SET "
                    ...
                    + inventory_productName.getText() + "',category='"
    ...
    public void inventoryDeleteBtn() {
        if (Data.id == 0) {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                alert.setTitle("Error Message");
                alert.setHeaderText(null);
                alert.setContentText("Deletion was Cancelled");
                alert.showAndWait();
            }
    ...
    //making a behaviour for import button 
    public void inventoryImportBtn() {
        ...
        if (file != null) {
            ...
            image = new Image(file.toURI().toString(), 148, 156, false, true);
    ...
    public void inventorySelectData() {
        ...
        image = new Image(path, 148, 156, false, true);
        inventory_imageView.setImage(image);
    }
    ...
    /* public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            try {
                ...
                JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\Shivani\\OneDrive\\Documents\\NetBeansProjects\\RestaurantManagementSystem\\src\\restaurantmanagementsystem\\reportRest.jrxml");
    ...
    public void logout() {
        try {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                //to hide the mainform
                logout_btn.getScene().getWindow().hide();

                //link your login form and display it when you logout
